...
Tor = robot.world.define_custom_wall(anki_vector.objects.CustomObjectTypes.CustomType00, anki_vector.objects.CustomObjectMarkers.Triangles5, width_mm=200.0, height_mm=300.0, marker_width_mm=170.0, marker_height_mm=170.0)
print(Tor)
print(Tor.custom_type==anki_vector.objects.CustomObjectTypes.CustomType00)
robot.Tor_pose = None
